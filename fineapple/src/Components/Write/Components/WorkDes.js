    ...
    return (
        <div className="workdes">
            <div className="workdes__container">
                ...
                <textarea type="text" autoComplete="none" className="description__input" />
                <div className="workdes__imgDrop">
                    <h1 className="workdes__imgDrop__title">부가적인 사진 및 파일 (선택 항목) </h1>
                    ...
                    <p>첨부파일은 각 <b> 100 MB </b>이하 <b>최대 5개</b>까지 등록 가능합니다. </p>
                </div>
